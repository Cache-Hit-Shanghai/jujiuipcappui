...
import { JuJiuInformation, IconBack, JuJiuMain, IconButton } from '@/jujiu-ui-components/core/core-ui';
				...
				<Box flex={{ grow: 1, shrink: 1 }} overflow='auto'>
					<Stack fill anchor='center'>
						<Box
							...
							background={{
								image:
									'url(https://tse2-mm.cn.bing.net/th/id/OIP-C.ke-oC-HNGvr6A7xWstYjsgHaFS?pid=ImgDet&rs=1)',
								size: 'contain',
							}}
						/>
						{type === 'video' && (
