...
import { Text, Box, RadioButtonGroup, Nav, Button, Heading, TextArea } from 'grommet';
import { useState } from 'react';
import { JuJiuItemButton, JuJiuItemLink } from '@/jujiu-ui-components/core/core-item';
import { IconBack, JuJiuMain, JuJiuLayer } from '@/jujiu-ui-components/core/core-ui';
	...
	return (
		<Box fill>
			...
			<JuJiuMain>
				...
				<JuJiuItemLink label='通讯录' href='/device/settings/contacts' />
