				...
				<Box flex={{ grow: 1, shrink: 1 }} style={{ position: 'relative' }}>
					...
					>
						<Box
							width='20px'
							height='20px'
							border={{ color: '#00ff33', size: 'medium', side: 'top' }}
							style={{ position: 'absolute', top: 0 }}
						/>
						<Box
							width='20px'
							height='20px'
							border={{ color: '#00ff33', size: 'medium', side: 'left' }}
							style={{ position: 'absolute', top: 0 }}
						/>
						<Box
							width='20px'
						...
						<Box
							width='20px'
							height='20px'
							border={{ color: '#00ff33', size: 'medium', side: 'right' }}
							style={{ position: 'absolute', right: 0 }}
						/>
						<Box
							width='20px'
							height='20px'
							border={{ color: '#00ff33', size: 'medium', side: 'bottom' }}
						...
						<Box
							...
							border={{ color: '#00ff33', size: '3px', side: 'bottom' }}
							style={{
